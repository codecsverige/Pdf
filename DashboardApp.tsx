...
const styles = StyleSheet.create<any>({
  ...
  pdfLabelText: { color: '#FFFFFF', fontWeight: '900', fontSize: 12 },
  ...
  moreTitle: { color: INK, fontSize: 12.5, fontWeight: '900' },
  ...
  recentTitle: { color: INK, fontSize: 16, fontWeight: '900' },
  ...
  recentPdfText: { color: BRAND, fontSize: 10, fontWeight: '900' },
  ...
  screenTitle: { color: INK, fontSize: 21, fontWeight: '900' },
  ...
  historyPdfText: { color: BRAND, fontWeight: '900', fontSize: 10 },
  ...
  privacyTitle: { color: '#065F46', fontSize: 12.5, fontWeight: '900' },
  ...
  toolHeaderTitle: { color: INK, fontSize: 17, fontWeight: '900' },
  ...
  workspaceTitle: { color: INK, fontSize: 20, fontWeight: '900' },
  ...
  localTagText: { color: '#059669', fontSize: 8, fontWeight: '900' },
  ...
  optionTitle: { color: '#344054', fontSize: 11.2, fontWeight: '900' },
  ...
  runText: { color: '#FFFFFF', fontSize: 13, fontWeight: '900' },
  ...
  compressionTitle: { color: '#1D4ED8', fontSize: 9.5, fontWeight: '900', textTransform: 'uppercase' },
  compressionNumbers: { color: '#1E3A8A', fontSize: 16, fontWeight: '900', marginTop: 2 },
  ...
  resultTitle: { color: '#065F46', fontSize: 13, fontWeight: '900' },
  ...
  downloadMainText: { color: '#FFFFFF', fontSize: 12, fontWeight: '900' },
